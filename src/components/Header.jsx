      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <button
            ...
            className="lg:hidden p-2 rounded-md text-gray-700 hover:text-solar-600 hover:bg-gray-100 transition-colors"
            ...
            <div className="flex flex-col space-y-4">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-gray-700 hover:text-solar-600 font-medium py-2 transition-colors"
              ...
              <a
                href="tel:+18885551234"
                className="flex items-center text-gray-700 hover:text-solar-600 py-2 transition-colors"
              >
                <svg
                  className="w-5 h-5 mr-2"
                  fill="none"
