 ...
 * Centralized SVG icons for consistent use across the site
 */
...
export function StarIcon({ filled = false, ...props }) {
  if (filled) {
    return (
      <svg {...mergeProps({ fill: 'currentColor', stroke: 'none', ...props })} viewBox="0 0 20 20">
...
// Filled check for trust signals
