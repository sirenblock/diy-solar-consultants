...
## Your Mission
Create a comprehensive FAQ page that addresses common questions about DIY solar, our services, costs, processes, and expectations using an accordion UI for easy navigation.

## Company Context
**DIY Solar Consultants** receives many of the same questions from potential clients. This FAQ page should provide detailed, helpful answers while building confidence in the DIY solar approach and our services. It should also reduce support burden by answering questions proactively.
...
- Subheading: "Everything you need to know about DIY solar design and our services"
- Search bar: "Search FAQs..." (filters questions in real-time)
...
Sticky sidebar navigation (desktop) or dropdown menu (mobile)
...
**Q1: How much can I really save by going DIY?**
A: Most homeowners save 40-60% compared to professional installation, typically $12,000-$18,000 on an average residential system. Here's the breakdown:
...
[Link to Solar Calculator to estimate your specific savings]

---

**Q2: Is DIY solar really a good idea? Can I do it myself?**
A: If you're reasonably handy and comfortable with electrical work (or willing to hire an electrician for final connections), yes! Most DIY solar installers successfully complete their projects by:
...
**Q3: How long does a DIY solar installation typically take?**
...
**Q4: What's the difference between your service and just doing it completely myself?**
...
**Q5: Will solar work in my state/climate?**
A: Yes! Solar works in all 50 states - even Alaska. Here's why:
...
[Use our calculator to see production estimates for your specific location]

---

### CATEGORY 2: Our Services

**Q6: What exactly do you provide?**
A: We offer four core services, available individually or as packages:

**1. Solar System Design ($XXX)**
...
**2. Permitting Plansets ($XXX or included in design)**
...
**3. Equipment Sourcing ($ service fee)**
...
**4. Technical Consulting ($XXX/hour or package)**
...
**Q7: How long does the design process take?**
A: Standard turnaround: **5-7 business days**
...
**Expedited service available:** 2-3 business days (+$XXX)
...
**Q8: Do you provide engineering stamps/PE seals?**
A: **Yes!** We have licensed Professional Engineers (PE) in all 50 states.
...
**Q9: What if my permit gets rejected?**
A: Our **98% first-time approval rate** means this rarely happens, but if it does:
...
**Q10: Can you help with equipment sourcing? How much can I save?**
A: Yes! We can source all equipment for your system.
...
**Q11: What information do you need to create my design?**
A: We need:
...
[Start design request form]

---

**Q12: Can you design systems with battery backup?**
A: Absolutely! We design all types of battery storage systems:
...
**Q13: Do you design commercial systems?**
A: Yes! We design commercial solar systems of all sizes.
...
[Contact us for commercial projects]

---

### CATEGORY 4: Permitting & Codes

**Q14: How does the permitting process work?**
A: Here's the typical flow:
...
**Q15: What codes and standards do solar systems need to meet?**
A: Solar installations must comply with several codes:
...
**Q16: Do I need to pull the permit myself?**
A: Depends on your jurisdiction:
...
**Q17: What equipment brands do you recommend?**
A: We only recommend tier-1 manufacturers with proven track records:
...
[See detailed equipment comparisons]

---

**Q18: How much does a typical DIY solar system cost?**
A: Costs vary by system size, equipment, and location, but here are typical ranges:
...
[Use our calculator for your specific costs]

---

**Q19: Are there financing options for DIY solar?**
A: Yes! Several financing options exist:
...
**Q20: How long do solar panels and equipment last?**
A: Solar systems are very long-lived:
...
**Q21: How difficult is the installation really?**
A: Difficulty depends on system size and your skills:
...
**Q22: Do I need to hire an electrician?**
A: Depends on your electrical knowledge and local requirements:
...
**Q23: What tools do I need for installation?**
A: Most are common tools, some are solar-specific:
...
**Q24: Should I add battery storage?**
A: Depends on your goals and situation:
...
[Contact us to discuss battery options]

---

**Q25: How much battery capacity do I need?**
A: Depends on what you want to power and for how long:
...
**Q26: What kind of support do you provide during installation?**
A: Comprehensive support throughout your project:
...
**Q27: What if something goes wrong with my system?**
A: Here's how issues are handled:
...
**Q28: Do you offer any guarantees?**
A: Yes, several guarantees:
...
- "No results" message with contact link

**Still Have Questions Section:**
- After all FAQs
- Headline: "Didn't find what you're looking for?"
- CTA buttons:
  - "Contact Us" (primary)
  - "Schedule Consultation"
  - "Try Solar Calculator"
- Text: "We're happy to answer any questions about DIY solar or our services"
...
**React Component:** `src/pages/faq.jsx`

**Accordion UI:**
- Expand/collapse questions
- Smooth animations
- One open at a time OR multiple open (design choice)
...
**SEO:**
- Meta title: "FAQ - DIY Solar Questions Answered | DIY Solar Consultants"
- Meta description: "Get answers to common questions about DIY solar installation, design services, costs, permitting, equipment, and our process. Expert guidance from licensed PE engineers."
...
**Performance:**
- Lazy render (render only visible accordions initially)
- Smooth scroll
...
```json
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How much can I really save by going DIY?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Most homeowners save 40-60% compared to professional installation..."
    }
  }]
}
```
...
- DIY solar installation questions
- Solar permit questions
- Solar equipment questions
- Solar cost questions

## Tone
Helpful, educational, honest, transparent. Anticipate concerns and address them directly. Be realistic about challenges while highlighting solutions.

## Deliverables
1. `src/pages/faq.jsx` - FAQ page with accordion UI
2. Search functionality component
3. Category navigation
4. Accordion component (reusable)
5. FAQ data structure (JSON or content file)
6. Styling (Tailwind or CSS module)
7. Mobile responsive implementation
8. SEO meta tags and FAQPage schema markup
9. Accessibility compliance

**Build in diy-solar-consultants directory. Make it comprehensive, searchable, and helpful. This page should answer questions and build confidence in DIY solar.**
